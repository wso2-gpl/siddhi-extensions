...
public class ExecutionPlansCount {
    ...
    public static void upCount(){
        ...
        System.out.println("DEBUG: upCount() numberOfExecutionPlans after update = "+ numberOfExecutionPlans);
    }
    ...
    public static void downCount(){
        ...
        ExecutionPlansCount.numberOfExecutionPlans -=1;
        System.out.println("DEBUG: downCount() numberOfExecutionPlans after update = "+ numberOfExecutionPlans);
    }
}
